...
class ProgramResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return $form->schema([
            ...
            Forms\Components\Textarea::make('beneficiaires_fr')->label('Bénéficiaires'),
            Forms\Components\Textarea::make('indicateurs_fr')->label('Indicateurs'),
            Forms\Components\Textarea::make('partenaires_souhaites_fr')->label('Partenaires souhaités'),
