...
@section('content')
    <section class="max-w-7xl mx-auto px-4 py-20">
        ...
        <p class="text-[#4a453c] mt-4 max-w-2xl leading-relaxed">Santé mentale communautaire, résilience humaine, parentalité positive, protection de l'enfant, leadership féminin, développement communautaire.</p>
