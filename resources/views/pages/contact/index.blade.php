    ...
    <section class="max-w-7xl mx-auto px-4 py-20 grid md:grid-cols-2 gap-16">
        ...
        <div>
            ...
            <form method="POST" action="{{ route('partner.store', app()->getLocale()) }}" class="space-y-6">
                ...
                <div class="grid sm:grid-cols-2 gap-6">
                    <div>
                        <label class="block text-xs font-bold uppercase tracking-widest text-[#6B2A28] mb-2">Organisation <span class="text-[#C99A3E]">*</span></label>
                    ...
                    <div>
                        <label class="block text-xs font-bold uppercase tracking-widest text-[#6B2A28] mb-2">Responsable <span class="text-[#C99A3E]">*</span></label>
                ...
                <div class="grid sm:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label class="block text-xs font-bold uppercase tracking-widest text-[#6B2A28] mb-2">Type de partenariat</label>
                        <input type="text" name="type_partenariat"
                               class="w-full bg-transparent border-b border-[#d8cfb8] focus:border-[#123D2E] outline-none py-2 text-sm transition">
                    </div>
                </div>
                <div>
                    <label class="block text-xs font-bold uppercase tracking-widest text-[#6B2A28] mb-2">Message</label>
        ...
        <div>
            ...
            <form method="POST" action="{{ route('contact.store', app()->getLocale()) }}" class="space-y-6">
                ...
                <div>
                    <label class="block text-xs font-bold uppercase tracking-widest text-[#6B2A28] mb-2">Sujet</label>
                    <input type="text" name="sujet"
                           class="w-full bg-transparent border-b border-[#d8cfb8] focus:border-[#123D2E] outline-none py-2 text-sm transition">
                </div>
                <div>
                    <label class="block text-xs font-bold uppercase tracking-widest text-[#6B2A28] mb-2">Message <span class="text-[#C99A3E]">*</span></label>
