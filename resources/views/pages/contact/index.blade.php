...
@section('content')
    ...
    <section class="max-w-7xl mx-auto px-4 pb-20 grid lg:grid-cols-2 gap-8 reveal">
        <div class="bg-white border-t-2 border-[#C99A3E] border-x border-b border-x-[#eadfca] border-b-[#eadfca] rounded-3xl p-8">
        ...
        <div class="bg-white border-t-2 border-[#6B2A28] border-x border-b border-x-[#eadfca] border-b-[#eadfca] rounded-3xl p-8">
            <div class="flex items-center gap-2 mb-6">
