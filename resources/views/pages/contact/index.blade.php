...
@section('content')
    ...
    <section class="max-w-7xl mx-auto px-4 py-16 reveal">
        ...
        <div class="mt-5 border border-[#eadfca] p-2 bg-white">
    ...
    {{-- ===== FORMULAIRES ===== --}}
    <section class="max-w-7xl mx-auto px-4 pb-20 grid lg:grid-cols-2 gap-8 reveal">
        <div class="bg-white border-t-2 border-[#C99A3E] border-x border-b border-x-[#eadfca] border-b-[#eadfca] p-8">
            <div class="flex items-center gap-2 mb-6">
                ...
                <p class="text-xs font-bold text-[#6B2A28] uppercase tracking-widest">{{ __('forms.nous_ecrire') }}</p>
            </div>

            @if ($errors->any())
                <div class="border-l-2 border-[#6B2A28] bg-[#F6F1E4] text-[#6B2A28] text-sm p-3 mb-6">
