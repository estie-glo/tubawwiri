    ...
    <section class="max-w-5xl mx-auto px-4 py-20 grid md:grid-cols-2 gap-16">
        ...
        <div>
            ...
            <form method="POST" action="{{ route('academy.enroll.store', app()->getLocale()) }}" class="space-y-6">
                ...
                <div>
                    <label class="block text-xs font-bold uppercase tracking-widest text-[#6B2A28] mb-3">Niveau</label>
                ...
                <div>
                    <label class="block text-xs font-bold uppercase tracking-widest text-[#6B2A28] mb-3">Mode</label>
                    <div class="grid grid-cols-2 gap-3 text-sm">
                        <label class="relative block cursor-pointer">
                            <input type="radio" name="mode" value="en_ligne" checked class="peer sr-only">
                            <span class="block border border-[#d8cfb8] peer-checked:border-[#123D2E] peer-checked:bg-[#123D2E] peer-checked:text-white px-3 py-2.5 text-center transition">En ligne</span>
                        </label>
                        <label class="relative block cursor-pointer">
                            <input type="radio" name="mode" value="presentiel" class="peer sr-only">
                            <span class="block border border-[#d8cfb8] peer-checked:border-[#123D2E] peer-checked:bg-[#123D2E] peer-checked:text-white px-3 py-2.5 text-center transition">Présentiel</span>
                        </label>
                    </div>
                </div>
