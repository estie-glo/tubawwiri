...
@section('content')
    <section class="max-w-7xl mx-auto px-4 py-20">
        ...
        <h1 class="font-display text-3xl md:text-4xl font-semibold text-[#123D2E] mt-2">Nos impacts</h1>
        <p class="text-[#4a453c] mt-4 max-w-2xl leading-relaxed">Bénéficiaires, formations, partenaires, projets et communautés accompagnées à travers l'Afrique.</p>

        <div class="grid md:grid-cols-4 gap-px bg-[#e5ddc8] mt-12">
            @foreach ($stats as $stat)
                <div class="bg-white p-8 text-center">
                    <p class="font-display text-4xl font-semibold text-[#123D2E]">+{{ $stat->value }}</p>
        ...
        @if ($testimonials->isNotEmpty())
            <div class="mt-20">
                <p class="text-xs font-bold text-[#C99A3E] uppercase tracking-[0.25em]">Témoignages</p>
                <h2 class="font-display text-2xl md:text-3xl font-semibold text-[#123D2E] mt-2 mb-10">Ce qu'ils disent de nous</h2>
